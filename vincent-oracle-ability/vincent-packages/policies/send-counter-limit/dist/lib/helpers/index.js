 ...
 */
export async function checkSendLimit(userAddress, maxSends, timeWindowSeconds) {
    try {
        ...
        const contract = new ethers.Contract(counterSignatures.address, [
...
/**
   ...
   */
export async function resetSendCounter(userAddress, pkpPublicKey) {
